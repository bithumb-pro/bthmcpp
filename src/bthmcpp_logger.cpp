...
int    BthmCPP_logger::debug_level   = 1;
string BthmCPP_logger::debug_log_file = "/tmp/bthmwatch.log";
int    BthmCPP_logger::debug_log_file_enable = 0;
FILE  *BthmCPP_logger::log_fp = NULL;



//-----------------------------------------------
void 
BthmCPP_logger::write_log( const char *fmt, ... ) 
{
    if ( debug_level == 0 ) {
        return;
    }
...
void 
BthmCPP_logger::write_log_clean( const char *fmt, ... ) 
{
    if ( debug_level == 0 ) {
        return;
    }
...
//---------------------
void 
BthmCPP_logger::open_logfp_if_not_opened() {
...
//---------------------
void 
BthmCPP_logger::set_debug_level( int level ) 
{
    debug_level = level;
}
...
//--------------------
void 
BthmCPP_logger::set_debug_logfile( string &pDebug_log_file ) 
{
...
//--------------------
void 
BthmCPP_logger::enable_logfile( int pDebug_log_file_enable ) 
{
